document.addEventListener('DOMContentLoaded', () => {
    ...
    function openModal(notebookId) {
        ...
        // Atualiza o link do WhatsApp no modal
        // !! SUBSTITUA SEU-NUMERO AQUI !!
        const whatsappNumber = '5599981543912'; // Substitua pelo seu número real
        const whatsappMessage = `Olá! Tenho interesse no notebook "${notebook.nome}" (${notebook.disponivel ? 'Disponível' : 'Alugado'}). Poderia confirmar a disponibilidade e condições?`;
        modalWhatsAppLink.href = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(whatsappMessage)}`;

        // Gerencia a visibilidade do botão de alugar
